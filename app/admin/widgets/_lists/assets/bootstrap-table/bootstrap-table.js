  ...
  var BootstrapTable = /*#__PURE__*/function () {
    ...
    _createClass(BootstrapTable, [{
        ...
        if (index !== -1) {
          ...
          if (this.options.sortClass !== undefined) {
            ...
            timeoutId = setTimeout(function () {
              ...
              _this3.$el.find("tr:not(.ignore) td:nth-child(".concat(index + 1, ")")).addClass(_this3.options.sortClass);
            }, 250);
          }
      ...
      value: function _updateCellOnly(field, index) {
        ...
        this.$body.find(">tr:not(.ignore)[data-index=".concat(index, "]")).find(">td:eq(".concat(fieldIndex, ")")).replaceWith($$p(rowHtml).find(">td:eq(".concat(fieldIndex, ")")));
        this.initBodyEvent();
        this.initFooter();
        this.resetView();
        this.updateSelected();
