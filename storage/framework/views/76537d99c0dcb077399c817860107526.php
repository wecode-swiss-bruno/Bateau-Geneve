...
<div class="form-row">
    <div class="col">
        <?php echo form_error('guest', '<div class="alert alert-danger help-block text-danger">', '</div>'); ?>

        <?php echo form_error('date', '<div class="alert alert-danger help-block text-danger">', '</div>'); ?>

        <?php echo form_error('time', '<div class="alert alert-danger help-block text-danger">', '</div>'); ?>
