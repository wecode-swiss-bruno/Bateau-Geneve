        ...
        <table class="table table-borderless">
            ...
            <?php $__currentLoopData = $customerReservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="color: <?php echo e($reservation->status_color); ?>;"><b><?php echo e($reservation->status->status_name); ?></b></td>
                    ...
                    <td><?php echo e($reservation->table_name); ?></td>
                    ...
                    <td>
                        ...
                        <?php if($__SELF__->showCancelButton()): ?>
                            <?php echo controller()->renderPartial($__SELF__.'::cancel_modal', ['customerReservation' => $reservation]); ?>
                        <?php endif; ?>
                    </td>
                </tr>
