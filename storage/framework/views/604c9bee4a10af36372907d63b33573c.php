...
Your reservation **<?php echo e($reservation_number); ?>** at **<?php echo e($location_name); ?>** has been updated to the following status:
<br>
...
<?php \System\Classes\MailManager::instance()->startPartial('button', ['url' => $reservation_view_url, 'type' => 'primary']); ?>
